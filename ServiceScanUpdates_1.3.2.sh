...
echo -e "${CYAN}"
echo "#########################################################"
echo "#      Start downloading and installing  ServiceScanUpdates      #"
echo "#########################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/310/refs/heads/main/enigma2-plugin-extensions-ServiceScanUpdates_1.3.2_all.ipk"
IPK_NAME="enigma2-plugin-extensions-ServiceScanUpdates_1.3.2_all.ipk"
